...
all: unit-tests dhcp-proxy-ipxe image-dhcp-proxy-ipxe lint
...
.PHONY: $(ARTIFACTS)/dhcp-proxy-ipxe-linux-amd64
$(ARTIFACTS)/dhcp-proxy-ipxe-linux-amd64:
	@$(MAKE) local-dhcp-proxy-ipxe-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: dhcp-proxy-ipxe-linux-amd64
dhcp-proxy-ipxe-linux-amd64: $(ARTIFACTS)/dhcp-proxy-ipxe-linux-amd64  ## Builds executable for dhcp-proxy-ipxe-linux-amd64.

.PHONY: $(ARTIFACTS)/dhcp-proxy-ipxe-linux-arm64
$(ARTIFACTS)/dhcp-proxy-ipxe-linux-arm64:
	@$(MAKE) local-dhcp-proxy-ipxe-linux-arm64 DEST=$(ARTIFACTS)

.PHONY: dhcp-proxy-ipxe-linux-arm64
dhcp-proxy-ipxe-linux-arm64: $(ARTIFACTS)/dhcp-proxy-ipxe-linux-arm64  ## Builds executable for dhcp-proxy-ipxe-linux-arm64.

.PHONY: dhcp-proxy-ipxe
dhcp-proxy-ipxe: dhcp-proxy-ipxe-linux-amd64 dhcp-proxy-ipxe-linux-arm64  ## Builds executables for dhcp-proxy-ipxe.
...
.PHONY: image-dhcp-proxy-ipxe
image-dhcp-proxy-ipxe:  ## Builds image for dhcp-proxy-ipxe.
	@$(MAKE) registry-$@ IMAGE_NAME="dhcp-proxy-ipxe"
